...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="{{ route('homepage') }}" class="nav__logo">KELIUNG<i class="bx bxs-map"></i>SUMBAWA</a>
        ...
        <div class="footer__container container grid">
            <div>
                <a href="{{ route('homepage') }}" class="footer__logo">
                    KELIUNG<i class="bx bxs-map"></i>SUMBAWA
                </a>
                <p class="footer__description">
                    Visi kami adalah membantu orang menemukan <br />
                    Tempat wisata Sumbawa terbaik untuk <br> bepergian dengan keamanan tinggi.
                </p>
            </div>
